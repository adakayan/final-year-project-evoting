...
<nav id="menu" style="background:url(image/navBg.png repeat-x;)">
   ...
   <div id="whole">
    ...
    <center><b><p style="font-family: Arial, Helvetica, sans-serif;font-size: 40px;color:red;">Candidate List</p></b></center>
    	<div id="cont">
    	<table border="1">
    	<tr><td><b>Party</b></td><td><b>Candidate</b></td><td><b>Constituency</b></td><td><b>Approve status</b></td></tr>
<%
...
<tr>
	...
	<td><%=res.getString("Approve")%></td>
	<%String s=res.getString("Approve");%>
	<td><input type="submit" id="submit" value="Active" formaction="reg.jsp?choice=7&Partyname=<%=res.getString("Partyname")%>&Constituency=<%=res.getString("Constituency")%>&Name=<%=res.getString("Name")%>"></td>
	<td><input type="submit" id="submit" value="Deactive" formaction="reg.jsp?choice=14&Partyname=<%=res.getString("Partyname")%>&Constituency=<%=res.getString("Constituency")%>&Name=<%=res.getString("Name")%>"></td>
	<%} %></tr></form>
