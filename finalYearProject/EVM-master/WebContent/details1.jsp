...
<%} %>
 <div id="whole">
    ...
    <center><b><p style="font-family: Arial, Helvetica, sans-serif;font-size: 40px;color:red;">Election Details</p></b></center>
    	<div id="cont">
    	<table border="1">
    	<tr><td><b>ElectionDate</b></td><td><b>Constituency</b></td><td><b>Countingdate</b></td><td><b>Total Voters</b></td></tr>
    	<%
    	...
    	<tr><form method="post">
    		<td><%=res.getString("Electiondate")%></td><td><%=res.getString("Constituency") %></td><td><%=res.getString("countingdate") %></td><td><%=res.getString("votercount") %></td>
        </form></tr>
    	<%}
    	%>
    	</table></div>
