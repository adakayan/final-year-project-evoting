...
DAO ob = new DAO();
   ...
   <p><label for="textfield4">Date of Election:</label>
                <input type="date" name="edate" id="edate" placeholder="dd-mm-yyyy" /><br>
                 <p><label for="textfield4">Constituency:</label>
                ...
                <p><label for="textfield4">Counting Date:</label>
                <input type="date" name="cdate" id="cdate" placeholder="dd-mm-yyyy" /><br>
                <%
                int id1;
               id1=Integer.parseInt(request.getParameter("id"));
               %>
                
                <input class="buttom" name="submit" id="submit" tabindex="5" value="Edit" type="submit" formaction="edit.jsp?id=<%=id1%>"/> 
            </form>
                </form>
