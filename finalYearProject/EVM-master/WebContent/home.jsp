...
<div id="whole">
<section id="sec">
<center><b><p style="font-family: Arial, Helvetica, sans-serif;font-size: 40px;color:red;">Welcome To Online Voting</p></b></center>
    	<div id="cont">
    	<h3>
    	<ul>
     <li>Voters have the opportunity to vote quickly and conveniently.</li>
     <li>The system can be used independent of the platform and device, be it on a smartphone, tablet or computer.</li>
     <li>People with disabilities can vote or take part in elections online without the help of a third party.</li>
       <li>Clear user guidance prevents formal errors such as illegible answers, missing signatures, incorrectly completed forms or invalid lists in the voting and election process.</li>
     <li>Voters receive confirmation that their vote has been correctly cast and saved in the ballot box.</li>
     <li>Votes can be counted quickly and precisely.</li>
      <li>E-voting is secure: votes are only transmitted and saved in encrypted and anonymized form. Sophisticated algorithms prevent votes from being manipulated without being detected.</li>
    </ul>
