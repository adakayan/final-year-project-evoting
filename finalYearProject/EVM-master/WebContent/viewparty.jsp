...
<div style="border: dotted 2px black;"><form method="post">
	...
	<center><h2>Approve Status:<%=s%></h2></center>
	<center><input type="submit" id="submit" value="Approve" formaction="reg.jsp?choice=8&Name=<%=res.getString("Name")%>&Leader=<%=res.getString("Leader")%>"></center>
